...
<section id="anc_cf_output">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td>
				<?php echo help("입력박스의 크기로  6 정도가 적당합니다."); ?>
                <?php echo gen_single_selectbox("","Nsize",   Array("col-sm-2","col-sm-3","col-sm-4","col-sm-6","col-sm-8","col-sm-10","col-sm-12"), Array("2","3","4","6","8","10","12"),$lalaSize,''); ?>
            </td>
        </tr>
		...
		?>
		<tr>
            <th scope="row"><label for="Nsize2">TextBox Rows</label></th>
            <td>
				<?php echo help("텍스트박스의 세로크기"); ?>
                <input type="text" name="Nsize2" id="Nsize2" value="<?php echo $lalaSize2; ?>" class="frm_input" size="5" placeholder="5">
            </td>
        </tr>
		<?php } ?>
		...
		?>
		<tr>
            <th scope="row"><label for="Nsize">속성</label></th>
            <td>
				<?php echo gen_single_selectbox("","Nsize2",   Array("Default","multiple"), Array("0","1"),$lalaSize,''); ?>
            </td>
        </tr>
		<?php }?>
