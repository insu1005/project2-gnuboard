...
// 견적요청 게시판
class Required extends Board {

    function getCategory($bo_table = '', $ca_name = '')
    {
        global $board, $is_admin;
    ...
    //출처 : 그누보드 찜닭님 https://sir.kr/pg_tip/13919#c_15551
    //수정 $result_idx 변수 초기화
