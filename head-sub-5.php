...
<!-- 콘텐츠 시작 { -->
    ...
    <div class="visual">
        ...
        <div class="lnb">
            <div class="inner">
                   <ul class="lnb-list">
                      <li class="on"><a href="/sub/sub5-1.php">이벤트</a></li>
                      <li><a href="/sub/sub1-2.php">공지사항</a></li>
                      <li><a href="/sub/sub1-3.php">MEDIA</a></li>
                      <li><a href="/sub/sub1-3.php">고객의 소리</a></li>
                      <li><a href="/sub/sub1-3.php">점주게시판</a></li>
                   </ul>
            </div>
        </div>