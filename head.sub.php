...
<meta charset="utf-8">
 <!-- search engine -s -->
 <meta name="keywords" content="피자, #오구쌀피자, 한국피자"> 
    <meta name="description" content="유기농 재료들을 총집합한 고품가브랜드 피자입니다">
    <!-- search engine -e -->
    <!-- opengraphic -s -->
    <meta property="og:title" content="오구오구 오구쌀피자">
    <meta property="og:type" content="website">
    <meta property="og:description" content="여러분들을 생각하고 만든 유기농 피자입니다">
    <meta property="og:image" content="/img/opengraphic.jpg">
    <!-- opengraphic -e -->
    <!-- favicon link -s -->
...
<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?>>
     <!-- skip-nav -s -->
     <div class="skip-nav">
        <a href="#" class="skip-nav-tit">본문바로가기</a>
    </div>
    <!-- skip-nav -s -->
<?php
