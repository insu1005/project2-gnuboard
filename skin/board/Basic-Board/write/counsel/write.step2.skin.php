...
<?php if ($w && $is_admin && $boset['effect']) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">결과</span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="wr_email">결과</label>
		<div class="col-sm-3">
	<?php } ?>
			<?php gen_single_selectbox("",'effect',Array("접수중","접수완료"),Array("0","1"),$write['effect'],'',0); ?>
		</div>
	</div>
<?php } ?>
...
<?php if ($is_name) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">이름<strong class="sound_only">필수</strong></span>
	</div>
...
<?php if ($is_password) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">비밀번호<strong class="sound_only">필수</strong></span>
	</div>
	<div class="form-group has-feedback">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php if ($is_email) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">E-mail</span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php if ($is_homepage) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">홈페이지</span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php if($boset['photo']){ ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">포토</span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php if ($is_category || $option) { ?>
	...
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>"><?php echo ($is_category) ? '분류' : '옵션';?></span>
	</div>
	<div class="form-group">
	<?php }else{ ?>
	<div class="form-group">
...
<?php if ($is_stag) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">태그</span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php if($boset['txt_style']){ ?>
<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
	<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">제목<strong class="sound_only">필수</strong></span>
</div>
<div class="form-group">
	<div class="col-sm-12">
<?php }else{ ?>
...
?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">링크 #<?php echo $i ?></span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php if($is_use_tag && $boset['use_tag']) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>"><?php echo ($is_stage)?'추가태그':'태그';?></span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="as_tag"><?php echo ($is_stage)?'추가태그':'태그';?></label>
		<div class="col-sm-10">
	<?php } ?>
			<input type="text" name="<?php echo ($is_stage)?'wr_10':'as_tag';?>" id="<?php echo ($is_stage)?'wr_10':'as_tag';?>" value="<?php echo ($is_stage)?$write['wr_10']:$write['as_tag'];?>" class="form-control input-sm" size="50">
		</div>
	</div>
<?php } ?>
	...
	switch($row['type']){
		case '1':	// 입력형
			if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
				...
				if($boset['txt_style']){
				echo '<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
					<span class="div-title-underbar-bold border-color bold '.$boset[font_size].'">'.$mdatas[$fvs]['iname'].$needstr.'</span>
				</div>
				<div class="form-group">
					<div class="col-sm-12">';
				}else{
					echo '<div class="form-group">
					<label class="col-sm-2 control-label" for="'.$fvs.'">'.$mdatas[$fvs]['iname'].$needstr.'</label>
					<div class="col-sm-'.$mdatas[$fvs]['size'].'">';
				}

				echo '<input type="text" name="N'.$fvs.'" id="N'.$fvs.'" value="'.$write[$fvs].'" '.$required.' class="'.$required.'form-control input-sm">';
						if($mdatas[$fvs]['bigo']) echo '<div class="text-muted font-12" style="margin-top:4px;">'.get_text($mdatas[$fvs]['bigo'], 1).'</div>';
				echo '</div>
				</div>';
		...
		case '17':	// 주소
			if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
				...
				echo '<label for="reg_zip" class="sound_only">우편번호</label>
						<label>
							<input type="text" name="Nzip" id="reg_Nzip" value="'.$write['zip'].'" '.$required.'class="'.$required.'form-control input-sm" size="6" maxlength="6">
						</label>
						<label>
			                <button type="button" class="btn btn-black btn-sm win_zip_find" style="margin-top:0px;" onclick="win_zip(\'fwrite\', \'Nzip\', \'Naddre1\', \'Naddre2\', \'Naddre3\', \'Naddre_jibeon\');">주소 검색</button>
						</label>

						<div class="addr-line">
							<label class="sound_only" for="reg_Naddre1">기본주소</label>
							<input type="text" name="Naddre1" id="reg_Naddre1" value="'.$write['addre1'].'" '.$required.'class="'.$required.'form-control input-sm" size="50" placeholder="기본주소">
						</div>

						<div class="addr-line">
							<label class="sound_only" for="reg_Naddre2">상세주소</label>
							<input type="text" name="Naddre2" id="reg_Naddre2" value="'.$write['addre2'].'" class="form-control input-sm" size="50" placeholder="상세주소">
						</div>

						<label class="sound_only" for="reg_Naddre3">참고항목</label>
						<input type="text" name="Naddre3" id="reg_Naddre3" value="'.$write['addre3'].'" class="form-control input-sm" size="50" readonly="readonly" placeholder="참고항목">
						<input type="hidden" name="Naddre_jibeon" value="'.$write['addre_jibeon'].'">';
						if($mdatas[$fvs]['bigo']) echo '<div class="text-muted font-12" style="margin-top:4px;">'.get_text($mdatas[$fvs]['bigo'], 1).'</div>';
				echo '</div>
				</div>';
		...
		case '18':	// 직장주소
			if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
				...
				echo '<label for="reg_ozip" class="sound_only">우편번호</label>
						<label>
							<input type="text" name="Nozip" id="reg_Nozip" value="'.$write['ozip'].'" '.$required.'class="'.$required.'form-control input-sm" size="6" maxlength="6">
						</label>
						<label>
			                <button type="button" class="btn btn-black btn-sm win_zip_find" style="margin-top:0px;" onclick="win_zip(\'fwrite\', \'Nozip\', \'Noaddre1\', \'Noaddre2\', \'Noaddre3\', \'Noaddre_jibeon\');">주소 검색</button>
						</label>

						<div class="addr-line">
							<label class="sound_only" for="reg_Naddre1">기본주소</label>
							<input type="text" name="Noaddre1" id="reg_Noaddre1" value="'.$write['oaddre1'].'" '.$required.'class="'.$required.'form-control input-sm" size="50" placeholder="기본주소">
						</div>

						<div class="addr-line">
							<label class="sound_only" for="reg_Naddre2">상세주소</label>
							<input type="text" name="Noaddre2" id="reg_Noaddre2" value="'.$write['oaddre2'].'" class="form-control input-sm" size="50" placeholder="상세주소">
						</div>

						<label class="sound_only" for="reg_Naddre3">참고항목</label>
						<input type="text" name="Noaddre3" id="reg_Noaddre3" value="'.$write['oaddre3'].'" class="form-control input-sm" size="50" readonly="readonly" placeholder="참고항목">
						<input type="hidden" name="Noaddre_jibeon" value="'.$write['oaddre_jibeon'].'">';
						if($mdatas[$fvs]['bigo']) echo '<div class="text-muted font-12" style="margin-top:4px;">'.get_text($mdatas[$fvs]['bigo'], 1).'</div>';
				echo '</div>
				</div>';
			...
			if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
				...
				<div class="form-group">
					...
					<div class="col-sm-'.$mdatas[$fvs]['size'].'">';
						...
						echo '<label class="select-line">'; gen_single_selectbox("","Nyear",$Ayears,$Ayears,$write['year'],'', $mdatas[$fvs]['size2']); echo '</label>';
						echo '<label class="select-line">'; gen_single_selectbox("","Nmonth",$Amonths,$Amonths,$write['month'],'', $mdatas[$fvs]['size2']); echo '</label>';
						echo '<label class="select-line">'; gen_single_selectbox("","Nday",$Adays,$Adays,$write['day'],'', $mdatas[$fvs]['size2']); echo '</label>';
			...
			if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
				...
				<div class="form-group">
					...
					<div class="col-sm-'.$mdatas[$fvs]['size'].'">';
						...
						if($boset['txt_editor']) echo editor_html('N'.$fvs, get_text($write[$fvs], 0));
				...
				if($boset['txt_editor']) $javastr .= get_editor_js('N'.$fvs);
...
<?php if($boset['txt_style']){ ?>
<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
	<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">상담내용</span>
</div>
<div class="form-group">
	<div class="col-sm-12">
<?php }else{ ?>
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_count">상담내용</label>
	<div class="col-sm-10">
<?php } ?>
...
<?php if($is_use_download) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">다운로드</span>
	</div>
	<div class="form-group">
	<?php }else{ ?>
	<div class="form-group">
...
<?php if($is_use_poll) { ?>
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">평가등록</span>
	</div>
	<div class="form-group">
		<div class="col-sm-12">
	<?php }else{ ?>
...
<?php } ?>
<?php if ($is_file && $boset['files']) { ?>



<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">첨부파일</span>
	</div>
...
<?php } ?>
	...
	<?php if($boset['txt_style']){ ?>
	<div class="div-title-underbar" style="margin-top:20px;margin-bottom:10px;">
		<span class="div-title-underbar-bold border-color bold <?php echo $boset[font_size];?>">첨부사진</span>
	</div>
	<div class="form-group">
		<div class="col-sm-10">
	<?php }else{ ?>
