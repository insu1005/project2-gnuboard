...
?>
<section id="bo_w">
    <h2 id="container_title" class="bo_w-title"><?php echo $g5['title'] ?></h2>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_2">매장전화번호<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="wr_3">영업시간<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="text" name="wr_3" value="<?php echo $write['wr_3'] ?>" id="wr_3" required class="frm_input required" size="50" maxlength="255">
            </td>
        </tr>

        <tr>
            <th scope="row"><label for="wr_4">서비스</label></th>
            <td>
                <input type="text" name="wr_4" value="<?php echo $write['wr_4'] ?>" id="wr_4" class="frm_input" size="50" maxlength="255">
            </td>
        </tr>
