...
?>
<!-- https://animate.style 애니메이트 사용 -->
<style>
.animation1 {animation:bounceInRight;animation-duration:2s;}
.animation2 {animation:bounceInLeft;animation-duration:2s;}
.animation3 {animation:bounceInUp;animation-duration:2s;}
.animation4 {animation:bounceInDown;animation-duration:2s;}
</style>
...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul" class="gall_row">
        <?php for ($i=0; $i<count($list); $i++) {
			...
			/* https://animate.style 애니메이트 사용 */
			/* 4가지 사용시 아래 2가지 주석처리하고 요거 주석 해제
			if($i%4==0) $ani_class = "animation1";
        	else if($i%4==1) $ani_class = "animation2";
			else if($i%4==2) $ani_class = "animation3";
			else $ani_class = "animation4";
            */

			// 2가지 사용
			if($i%2==0) $ani_class = "animation1";
        	else $ani_class = "animation2";
			/* https://animate.style 애니메이트 사용 */
         ?>
        <li class="<?php echo implode(' ', $classes); ?> <?php echo $ani_class ?>"> <!-- 애니메이트 사용 <?php echo $ani_class ?> 추가 -->
            <div class="gall_box">
