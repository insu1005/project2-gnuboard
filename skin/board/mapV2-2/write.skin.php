...
<section id="bo_w">
    ...
    <table class="w_tables" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php for ($i=1; $is_link && $i<=G5_LINK_COUNT-1; $i++) { ?>
        <tr>
            <td class="thead">웹사이트 Url</td>
            <td>
                <input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){ echo $write['wr_link'.$i]; } ?>" id="wr_link<?php echo $i ?>" class="frm_input full_input w_inputs"  placeholder="웹사이트 Url" style="width:60%;">
            </td>
        </tr>
        <?php } ?>
