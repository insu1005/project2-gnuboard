...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div class="bo_vc_w_wr">
        <div class="bo_vc_w_info">
            ...
            <input type="text" name="wr_name" value="<?php echo get_cookie("ck_sns_name"); ?>" id="wr_name" required class="frm_input w_inputs comm_mo_inp required" size="25" placeholder="이름">
            <label for="wr_password" class="sound_only">비밀번호<strong> 필수</strong></label>
            <input type="password" name="wr_password" id="wr_password" required class="frm_input w_inputs comm_mo_inp required" size="25" placeholder="비밀번호">
            <?php
            }
            ?>
            <?php
