...
<div class="sub-page">
	<div class="sub-nav">
		<div class="boxy-warp">
			...
			<a href="#">창업비용</a>
			<a href="#">창업FAQ</a>
			<a href="#" class="active">창업문의</a>
		</div>
	</div>
	<h2 class="sub-title">창업문의</h2>
	<div class="boxy-warp">
		<!-- e: top-nav-box -->
		<?php
		...
		<section id="bo_w">
				...
				<div class="tbl_frm01 tbl_wrap">
						...
						<tr>
							...
							<td class="wr_name">
								<input type="text" name="wr_subject" value="<?php echo $name ?>" id="wr_name2" required class="frm_input required" size="15" maxlength="15">            </td>
						</tr>
						<tr>
								<th scope="row"><div align="center">
