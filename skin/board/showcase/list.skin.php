...
?>
<link rel="stylesheet" href="<?=$board_skin_url?>/css/style_show.css" />
<link rel="stylesheet" href="<?=$board_skin_url?>/css/style-index5.css" />
<script type="text/javascript" src="<?=$board_skin_url?>/js/jquery.aw-showcase.min.js"></script>
				...
				<div class="showcase-slide">
					...
					<div class="showcase-content">
						...
						<div class="showcase-content-wrapper">
							...
							<img src="<?=$big_img_url?>" alt="01" width="700px" height="470px" />
							<p class="static-caption"><?=$list[$i]["subject"]?></p>
						</div>
					</div>
